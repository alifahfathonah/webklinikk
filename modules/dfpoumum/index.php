...
if (isset($_GET['aksi'])) {
  if ($_GET['aksi'] == 'reset') {
    mysqli_query($db, "TRUNCATE TABLE antrian");
...
if (isset($_GET['aksi'])) {
  if ($_GET['aksi'] == 'hapus') {
    ...
    mysqli_query($db, "DELETE FROM antrian WHERE id_pemeriksaan='$id_pemeriksaan'");
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Data Pendaftaran Poly Umum </h2>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <a href="index.php?page=daftarumum" class="btn btn-info" class="pull-right"><i class="fa fa-plus"></i> Tambah</a>
        <!-- <a href="index.php?page=dfpoumum&aksi=reset" class="btn btn-danger" class="pull-left"><i class="fa fa-history"></i> Reset Antrian</a>  <br><br> -->
        ...
        <table id="example" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            $query  = mysqli_query($db,"SELECT pendaftaran.*, pasien.nama_lengkap,dokter.nama, antrian.no_antrian,det_poly.layanan,pendaftaran.tgl_pendaftaran FROM antrian JOIN pendaftaran ON antrian.id_pemeriksaan=pendaftaran.id_pemeriksaan JOIN pasien ON pasien.no_rm = pendaftaran.no_rm JOIN dokter ON pendaftaran.id_dokter=dokter.id_dokter JOIN det_poly ON det_poly.kd_detpol=pendaftaran.kd_detpol WHERE det_poly.kd_detpol='5' AND DATE(pendaftaran.tgl_pendaftaran)='$date'");
            ...
            if ($hitung>0) {
              while ($pecah = mysqli_fetch_assoc($query)) {
                ...
                <tr>
                  ...
                  }else if ($pecah['keterangan'] == 'Periksa') {
                    echo "<span class='label label-info'>".$pecah['keterangan']."</span>";
                  }
                  else if ($pecah['keterangan'] == 'Selesai Diperiksa') {
                    echo "<span class='label label-info'>".$pecah['keterangan']."</span>";
                  }
                  else if ($pecah['keterangan'] == 'Telah Mengambil Obat') {
                    echo "<span class='label label-info'>".$pecah['keterangan']."</span>";
                  }
                  else if ($pecah['keterangan'] == 'Telah Melakukan Pembayaran') {
                    echo "<span class='label label-info'>".$pecah['keterangan']."</span>";
                  } ?></td>
                  <td>
                    <?php 

                    if ($pecah['keterangan']=='Menunggu Antrian') {
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="hidden" name="id_pemeriksaan1" id="id_pemeriksaan1" class="form-control col-md-7 col-xs-12" type="text">
                  </div>
                </div> 
      ...
      <div class="modal-footer">
        ...
        <a href="index.php?page=dfpoumum" class="btn btn-danger">Back</a>
      </div>
    </form>
  </div>
</div>
