...
if (isset($_POST['simpan'])) {
  ...
  mysqli_query($db, "UPDATE jad_dok SET
    hari='$tgl_jdwl',
    waktu_mulai='$jm_mulai',
    waktu_selesai='$jam_selesai',
    id_dokter='$id_dokter' WHERE id_jadwal='$id_jadwal'");
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        $query  = mysqli_query($db,"SELECT * FROM jad_dok WHERE id_jadwal='$id_jadwal'");
        ...
        if ($hitung>0) {
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <select class="form-control" name="id_dokter">
                  ...
                  while ($row = mysqli_fetch_assoc($query)) {
                    if ($pecah[id_dokter] == $row[id_dokter]) {
                     echo "<option value=$row[id_dokter] selected>$row[nama]</option>";
                   }
                   else {
          ...
          <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <a href="index.php?page=jaddok" class="btn btn-danger"> Kembali</a>              
