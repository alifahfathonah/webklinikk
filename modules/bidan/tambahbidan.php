<?php
  if (isset($_POST['simpan'])) {
    ...
    if (mysqli_fetch_assoc($result)) {
      ...
      echo "<script>window.location='index.php?page=tambahbidan'</script>";

      return false;
    }


    mysqli_query($db, "INSERT INTO bidan(id_bidan,nama,jk,alamat,agama,tempat_lahir,tgl_lahir,no_hp) VALUES ('$id_bidan','$nama','$jk','$alamat','$agama','$tempat_lahir','$tgl_lahir','$no_hp')");

    $pass = password_hash($pass, PASSWORD_DEFAULT);

    mysqli_query($db, "INSERT INTO users(id_user,nama,email,pasword,level) VALUES ('$id_bidan','$nama','$email','$pass','Bidan')");
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          $sql1  = "SELECT max(id_bidan) AS terakhirpas FROM bidan";
                          ...
                          $nextid1     = "BDN-".sprintf("%04s",$nexturut1);

                         ?>
                          <input type="text" name="id_bidan" required="required" value="<?php echo $nextid1; ?>" class="form-control col-md-7 col-xs-12" readonly>
                        </div>
                      </div>
                      <div class="form-group">
